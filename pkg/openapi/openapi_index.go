...
// nolint:lll // skip too long lines linting
const indexTempl = `<!-- HTML for static distribution bundle build -->
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <title>DocJSON UI</title>
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,700%7CSource+Code+Pro:300,600%7CTitillium+Web:400,600,700" rel="stylesheet">
